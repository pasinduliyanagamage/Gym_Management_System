...
public class GymClassDTO {package com.gym.gymmanagement.dto;
    ...
    public class GymClassDTO {
        ...
        public GymClassDTO(Long id, String className, String description, LocalDateTime scheduleTime, Integer durationMinutes, Integer capacity, String room, Long trainerId, String trainerName) {
            this.id = id;
        ...
        public static class Builder {
            ...
            public GymClassDTO build() {
                return new GymClassDTO(id, className, description, scheduleTime, durationMinutes, capacity, room, trainerId, trainerName);
            }
        }
